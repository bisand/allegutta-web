...
async function testImportEndpoint() {
  ...
  try {
    ...
    // Test CSV data with corrected Norwegian formatting and proper field alignment
    // All lines now have consistent 29 fields to match the saldo position
...
1000000002	2025-08-28	2025-08-28	2025-08-28	6627020	KJØPT	AAPL	US0378331005	10	150				1500		NOK					10	8500	8500	0		Buy Apple stock			1234567891`
    ...
    for (let i = 1; i < lines.length; i++) {
      ...
      const date = new Date(csvRow.Bokföringsdag)
    ...
    for (const { csvRow, id } of parsedTransactions) {
      try {
        ...
        const transactionData = {
          ...
          date: new Date(csvRow.Bokföringsdag),
